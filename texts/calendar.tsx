...
const CalendarText = () => {
  return (
    <p> Well, Bloben Calendar is just like any calendar app out there with exception of strong focus on encryption and maximum privacy.
      ...
      Only small part of data like dates and timezones for events and calendars are in plain text. This way notifications and repeated events be handled from the server.
